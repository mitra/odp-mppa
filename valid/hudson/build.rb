...
b.target("package") do
    ...
    b.run(:cmd => "cd install/; tar cf ../odp.tar local/k1tools/lib/ local/k1tools/share/odp/firmware local/k1tools/share/odp/build/ local/k1tools/k1*/include local/k1tools/doc/ local/k1tools/lib64", :env => env)
